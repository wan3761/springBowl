...
public class TileEntityLocker extends TileEntityLockableLoot implements ITickable
{
    private NonNullList<ItemStack> chestContents = NonNullList.<ItemStack>withSize(27, ItemStack.EMPTY);
    public boolean adjacentChestChecked;
    public TileEntityLocker adjacentChestZNeg;
    public TileEntityLocker adjacentChestXPos;
    public TileEntityLocker adjacentChestXNeg;
    public TileEntityLocker adjacentChestZPos;
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityLocker.class, new String[] {"Items"}));
    }
    ...
    private void setNeighbor(TileEntityLocker chestTe, EnumFacing side)
    {
    ...
    @Nullable
    protected TileEntityLocker getAdjacentChest(EnumFacing side)
    {
        ...
        if (this.isChestAt(blockpos))
        {
            ...
            {
                TileEntityLocker tileentitychest = (TileEntityLocker)tileentity;
